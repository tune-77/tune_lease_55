"""
温水式リース審査AI - lease_logic_sumaho10
sumaho9 に学習モデル（業種別ハイブリッド）を融合。データファイルはリポジトリルートで sumaho8/9 と共通。
起動: streamlit run lease_logic_sumaho10/lease_logic_sumaho10.py （リポジトリルートで実行）
"""
import sys
import os
