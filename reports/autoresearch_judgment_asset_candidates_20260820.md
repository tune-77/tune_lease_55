# Auto Research Judgment Asset Candidates (2026-08-07 to 2026-08-20)
...
### 2026-07-18 / application_rule / preserved_human_review

- Claim: 更新設備の増額申込は、既存設備の稼働率、粗利改善見込み、旧設備の処分予定が説明と整合する時だけ前向きに見る。
- Edited claim: 更新設備の増額申込は、既存設備の稼働率、粗利改善見込み、旧設備の処分予定が説明と整合する時だけ前向きに見る。
- Source section: preserved_state
- Evidence: `state://autoresearch_judgment_asset_candidate_state/0b5ce59551c6f575`
- Status: candidate / not_promoted
- Asset quality: actionable / reasons=none
- Metrics: use=2, useful=2, rejected=0, neutral=0, verified=unverified
- Deduped similar: 0
