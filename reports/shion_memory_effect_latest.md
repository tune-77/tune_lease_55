...
- Usage events: 1254
- Used memory ids: 213
- Impact-hint events: 77
- Usage by layer: {'long_term': 1127, 'mid_term': 81, 'persistent': 141, 'retrieval': 265, 'unknown': 473}
...
- mem_ae88cee835506182 [persistent/active] used=80 案件固有の事実はここへ置かない。案件DB、Obsidian、日次メモ、判断資産ログへ置く。
