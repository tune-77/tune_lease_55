...
- Usage events: 1365
- Used memory ids: 230
- Impact-hint events: 90
- Usage by layer: {'long_term': 1186, 'mid_term': 112, 'persistent': 215, 'retrieval': 275, 'unknown': 481}
...
- mem_c85d8a98a38807f5 [persistent/active] used=43 紫苑は、単なる回答生成ではなく、リース審査と改善判断の経験を選別し、判断資産へ変える。
