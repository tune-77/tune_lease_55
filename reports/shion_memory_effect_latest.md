...
- Usage events: 1211
- Used memory ids: 207
- Impact-hint events: 72
- Usage by layer: {'long_term': 1102, 'mid_term': 96, 'persistent': 123, 'retrieval': 258, 'unknown': 446}
...
- mem_ae88cee835506182 [persistent/active] used=66 案件固有の事実はここへ置かない。案件DB、Obsidian、日次メモ、判断資産ログへ置く。
...
- mem_4fd8e693bec5b1b6 [retrieval/active] used=43 要点: 工作機械は中古流通があるが、主軸稼働時間、制御装置の世代、メーカー、搬出・据付費で実質回収額が変わる。
...
- mem_c85d8a98a38807f5 [persistent/active] used=30 紫苑は、単なる回答生成ではなく、リース審査と改善判断の経験を選別し、判断資産へ変える。
