...
|---------|---------|---------|----------|------|
| P7-001 | [P7-001-lease-domain-glossary.md](P7-001-lease-domain-glossary.md) | リース業界ドメイン辞書（データ + ローダー） | draft | なし |
| P7-002 | [P7-002-rag-query-expansion.md](P7-002-rag-query-expansion.md) | RAG クエリ拡張（シノニム展開と search() 統合） | draft | P7-001 |
