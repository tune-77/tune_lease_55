...
読者だけが知る秘密：実は文明発展のための知識をリースするシステム。エージェント自身は一切知らない。
...
【1話の構成（1,500〜2,000字）】
① 案件発生（200字）：今週の依頼が来る。普通のリース申請——に見える
② エージェント各自の反応（400字）：それぞれの個性でリアクション
③ 小さなトラブルと掛け合い（600字）：認識のズレがコメディを生む
④ 解決と余韻（300字）：解決するが、読者だけに「もしかして……」と思わせる伏線
