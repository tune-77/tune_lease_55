...
def _pick_result_comment(risk_label: str, industry_major: str) -> str:
    """審査結果に応じたつん子コメントをJSONから選ぶ。業種優先・全業種フォールバック。"""
...
_COMMENTS: dict[str, list[str]] = {
    ...
    "random_idle": [
        ...
        "私、いつでもここにいます。呼ばれなくても来ます。それがつん子式。",
    ...
    "random_silly": [
        ...
        "私の名前「つん子」って8画目くらいで手が疲れるやつですよね。お世話になります。",
    ...
    # ── 歌う ──────────────────────────────────────────────────────────────
    "random_song": [
        "♪ あ〜なたのスコアは〜 七十一〜 承認ライン〜 ギリギリ〜 ♪（作詞：つん子）",
...
<div class="yanami-wrap">
  <div class="yanami-bubble">
    <div class="yanami-name">🍞 つん子さん</div>
    {safe}
  </div>
