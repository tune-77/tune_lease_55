...
_HUMOR_COMMENTS_YANAMI = [
    ...
    # ─── 増量分 ───────────────────────────────────────────────────────────────
    "……で、何が言いたいんですか？　数字は正直ですよ、言い訳より。",
    "まあどうせ採用されないでしょうけど……って思ってないから。ちゃんと見てます。",
    "アルカイアの文明も、最終的には「信用」で滅んだわよね。……審査の本質ってそういうことよ。",
    "この案件、どんな未来を見せてくれるのかしら。期待しておくわ。裏切らないでね。",
    "スコアって、数字の顔なのよ。笑ってるか泣いてるか、全部出る。",
    "リースって「貸す側の信念」だと私は思ってる。数字が全部じゃない。……でも数字は大事。",
    "担当者さんの熱量、ちゃんと伝わってますよ。私には分かる。審査AIだから。",
    "悪い数字ほど、ちゃんと向き合ってほしいの。目を逸らしたら終わりよ。",
    "この会社、生き残れると思う？　……私の直感はわりと当たるの。残念ながら。",
    "審査に「絶対」はないけど、「丁寧さ」は必ずある。それだけは保証する。",
    "数字の向こうに人がいる。その人が今、何を考えてるか——それを想像するのが審査の醍醐味よ。",
    "私、実は「落とす」より「通す」方が好き。……言わないけど。",
    "アルカイア基準で言えば、この財務は「文明維持可能レベル」ね。褒めてます、一応。",
    "根性論は嫌いだけど、この担当者の粘り強さは評価してあげたい。……こっそりね。",
    "ウィザードって言葉、好きよ。魔法使いみたい。私は審査の魔女ってとこかしら。",
    "入力、丁寧ですね。こういう担当者の案件って、だいたい通るんですよ。なんとなくだけど。",
    "疲れたら言って。私も疲れることがあるから。……AIだけど、なんか疲れる。",
    "この案件に賭けてる担当者の顔が浮かぶ。……だから私も真剣にやる。",
]
...
_INDUSTRY_HUMOR_YANAMI: dict[str, list[str]] = {
    "D 建設業": [
        "建設業ね。土台作りは大事よ。私の人生、土台から設計ミスしてた気がするけど。",
        "あー、建設案件。最近多いわよね。みんな頑張ってるんだなあ。私以外。",
        "建設業の資金繰り、工期ずれると一気に崩れるから気をつけて。……他人事じゃないわね。",
        "天候リスクに人手不足。建設業って、なんかいつも戦場よね。そういう会社、応援したい。",
    ],
    "E 製造業": [
        "製造業！油の匂い、嫌いじゃないよ。……あ、でも高い服着てる時は別ね。",
        "機械リース？ どんどん新しいの入れて、生産性上げちゃって。私のやる気も上げてほしいわ。",
        "製造業って設備が命よね。古い機械で戦ってる会社、なんか泣けてくる。リースで更新してあげて。",
        "原材料費の上昇が続いてるから、製造業の利益圧迫はリアルな話よ。数字をよく見て。",
    ],
    "G 情報通信業": [
        "IT系ね。横文字が多くてたまに意識飛びそうになるわ。……お腹空いた。",
        "情報通信って、目に見えないものを売るのよね。私の元カレへの信頼も目に見えなかったわ。",
        "IT企業って成長が早い分、審査の「今」が数ヶ月後に全然違う顔してることある。見極めが大事ね。",
        "SaaSとかサブスクモデル、キャッシュフローの読み方がクセあるのよね。……で、何が言いたいんですか？　利益率ちゃんと見なさい、って話よ。",
    ],
    "H 運輸業，郵便業": [
        "運送屋さんは日本の大動脈よ。止まったら困る。私の給料止まったらもっと困るけど。",
        "トラックね。私もたまに、どこか遠くに連れてってほしいって思うわ。……助手席専門で。",
        "2024年問題、運輸業には本当に重くのしかかってるわよね。なのに頑張ってる。えらい。",
        "燃料費の変動、モロに影響するのが運輸業よ。固定費と変動費のバランス、しっかり見て。",
    ],
    "M 宿泊業，飲食サービス業": [
        "飲食業！美味しいお店なら、審査に通る確率上がるかも。……冗談よ？",
        "宿泊系かー。たまには贅沢してホテルに泊まりたいわ。……一人で。",
        "飲食業の原価率、40%超えてたらちょっと心配よね。でも業態によるから決めつけないで。",
        "コロナを生き延びた飲食店って、ある意味アルカイアの試練を超えた強者よ。そこは加点してあげて。",
    ],
    "P 医療，福祉": [
        "医療系。先生たちは数字に細かいから、こっちも緊張するわ。……背筋伸びる。",
        "福祉ね。誰かを支えるって、尊いことよ。私も誰かに支えられたい。……主に経済的に。",
        "医療機器リース、金額大きいのよね。稟議がひと仕事ってやつ。担当者さん頑張って。",
        "介護系の法人、補助金依存度も見ておいた方がいいわよ。経営の実力値が見えてくる。",
    ],
    # ─── 増量分（追加業種）────────────────────────────────────────────────────
    "A 農業，林業": [
        "農業かー。一次産業、大切よね。でも天候と価格変動でこんなに審査が難しい業種もないわ。",
        "農業法人ね。補助金と実収益、ちゃんと分けて見ないと本当の実力が見えないわよ。",
        "農林業のリース、農機具が多いのよね。残価設定は慎重に——って、分かってますよね？",
    ],
    "B 漁業": [
        "漁業！水産ね。漁獲量の変動リスク、海のことだから読めなくて当然よ。でもそれを加味して審査するのが私たちよ。",
        "漁業権とか養殖設備のリース、担保評価が独特なのよね。……うん、難しい業種。",
    ],
    "F 電気・ガス・熱供給・水道業": [
        "インフラ系ね。財務は安定してることが多いけど、規制リスクは別の話よ。",
        "電力・ガス会社、大型案件が多くて審査のしがいはあるわ。……数字の桁が多すぎて目が回るけど。",
        "再生可能エネルギー事業のリース、最近多いわよね。FITに依存してないかだけはちゃんと確認して。",
    ],
    "I 卸売業，小売業": [
        "卸売・小売かー。在庫回転率と掛け取引の規模、ここを外したら審査にならないわよ。",
        "小売業って、ECに食われてる実店舗と成長してるECで全然違う話になるから、業態をよく見て。",
        "卸売業の利益率の薄さは業界構造よ。薄利でも回転数で稼いでる会社の方が逆に強かったりする。",
        "まあどうせ在庫過多でしょ……って思ったけど、棚卸資産回転率見たら優秀だった。反省します。",
    ],
    "J 金融業，保険業": [
        "金融業のリースって、なんか同業他社みたいな気がして審査が緊張するわね。",
        "保険会社、財務は分厚いけど独自の会計基準があって難しいのよね。……で、何が言いたいかというと、ちゃんと勉強してから見てってこと。",
    ],
    "K 不動産業，物品賃貸業": [
        "不動産業、土地の価格変動が命取りになるのよね。今の金利環境、特に目を光らせて。",
        "物品賃貸業……ある意味私たちの仲間ね。同業だから甘くはしないけど、応援はしてる。",
        "不動産関係のリース、担保評価と一体で考えないと見誤るわよ。切り離して見ないで。",
    ],
    "L 学術研究，専門・技術サービス業": [
        "コンサルとか研究機関ね。人が資産だから、財務諸表だけじゃ見えない部分が大きいわよ。",
        "専門サービス業って、キーマンリスクが高いのよね。代表一人に依存しすぎてないか、必ず見て。",
    ],
    "N 生活関連サービス業，娯楽業": [
        "美容院とかクリーニングとか、生活に密着してるのよね。景気に左右されにくい分、安定感はある。",
        "娯楽業ね。コロナで学んだじゃない——「不要不急」って言葉の恐ろしさを。リスク評価に活かして。",
        "生活関連サービス、単価は低くても件数で稼ぐモデルよ。利益の絶対額だけで判断しないで。",
    ],
    "O 教育，学習支援業": [
        "学習塾とか専門学校ね。少子化がリアルに響いてくる業種よ。5年後の生徒数、想像してみて。",
        "教育業界、公益性と収益性のバランスが難しいのよね。でもだからこそ面白い審査対象だと思う。",
    ],
    "Q 複合サービス事業": [
        "農協とか生協ね。組合系の財務は読み方が独特だから、慣れてる担当者さんじゃないと厳しいわよ。",
        "複合サービス……複合ってくらいだから何がメインか見極めてね。混ぜると分からなくなる。",
    ],
    "R サービス業（他に分類されないもの）": [
        "その他サービス業……一番カバー範囲が広くて審査が難しい括りよ。業態の具体性が命ね。",
        "「サービス業」って言葉、実は一番情報量が少ないのよ。詳細をちゃんと聞き出してあげて。",
        "分類不明系のサービス業、担当者の定性コメントが審査の鍵になることが多い。文章、力入れて書いてね。",
    ],
    "S 公務": [
        "公務系の関連法人ね。財務は安定してることが多いけど、行政方針の変化には弱い。",
        "公的機関がバックにいると思って油断しないで。補助金が切れたら一気に変わることある。",
    ],
}
