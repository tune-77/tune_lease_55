...
const candidate = {
  id: "cr-b259411afb954d6d",
  candidate_type: "application_rule",
  research_topic: "business_plan_specificity",
  claim: "受注根拠と返済原資を合わせて確認する。",
  evidence_path: "test-fixture",
...
const installScreeningDraft = async (page: Page) => {
  await page.addInitScript((draftCandidate) => {
