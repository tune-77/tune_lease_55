        ...
        <form ref={wizardFormRef} onSubmit={handleNext} onKeyDownCapture={handleWizardNumberEnter} className="w-full bg-white border-t-2 border-[#1A1A2E] px-4 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))] shrink-0 shadow-[0_-6px_20px_rgba(0,0,0,0.12)] rounded-t-2xl z-20">
          ...
          <div className="mb-4 space-y-3 max-h-[40vh] overflow-y-auto scrollbar-hide pb-2 px-1">
              ...
              <>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input type="text" inputMode="numeric" pattern="[0-9]*" name="company_no" value={formData.company_no} onChange={handleChange} placeholder="例: 123456" className={inp} />
                  </div>
                  <div>
            ...
            {step === 3 && (
              <div className="space-y-3">
                ...
                <div className="col-span-2">
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="nenshu" value={formData.nenshu} min="0" step="0.1" onChange={handleChange} placeholder="売上高 (百万円) ※必須" className={errors.nenshu ? inpErr : inpReq} />
                ...
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="gross_profit" value={formData.gross_profit} step="0.1" onChange={handleChange} placeholder="売上総利益 (百万円) ※赤字は例: -5" className={inp} />
                  <AmountChips amounts={PROFIT_AMOUNTS} activeValue={formData.gross_profit} onSelect={(value) => setQuickValue('gross_profit', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="op_profit" value={formData.op_profit} step="0.1" onChange={handleChange} placeholder="営業利益 (百万円) ※赤字は例: -5" className={inp} />
                  <AmountChips amounts={PROFIT_AMOUNTS} activeValue={formData.op_profit} onSelect={(value) => setQuickValue('op_profit', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="ord_profit" value={formData.ord_profit} step="0.1" onChange={handleChange} placeholder="経常利益 (百万円) ※赤字は例: -5" className={inp} />
                  <AmountChips amounts={PROFIT_AMOUNTS} activeValue={formData.ord_profit} onSelect={(value) => setQuickValue('ord_profit', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="net_income" value={formData.net_income} step="0.1" onChange={handleChange} placeholder="当期純利益 (百万円) ※赤字は例: -5" className={inp} />
            ...
            {step === 4 && (
              <div className="grid grid-cols-2 gap-2">
                <div className="col-span-2">
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="total_assets" value={formData.total_assets} min="0" step="0.1" onChange={handleChange} placeholder="総資産 (百万円) ※必須" className={errors.total_assets ? inpErr : inpReq} />
                ...
                <div className="col-span-2">
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="net_assets" value={formData.net_assets} step="0.1" onChange={handleChange} placeholder="純資産/自己資本 (百万円) ※債務超過は例: -5" className={inp} />
                  <AmountChips amounts={PROFIT_AMOUNTS} activeValue={formData.net_assets} onSelect={(value) => setQuickValue('net_assets', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="machines" value={formData.machines} min="0" step="0.1" onChange={handleChange} placeholder="機械装置 (百万円)" className={inp} />
                  <AmountChips amounts={CREDIT_AMOUNTS} activeValue={formData.machines} onSelect={(value) => setQuickValue('machines', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="other_assets" value={formData.other_assets} min="0" step="0.1" onChange={handleChange} placeholder="その他資産 (百万円)" className={inp} />
            ...
            {step === 5 && (
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="depreciation" value={formData.depreciation} min="0" step="0.1" onChange={handleChange} placeholder="減価償却(資産・百万円)" className={inp} />
                  <AmountChips amounts={SMALL_COST_AMOUNTS} activeValue={formData.depreciation} onSelect={(value) => setQuickValue('depreciation', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="dep_expense" value={formData.dep_expense} min="0" step="0.1" onChange={handleChange} placeholder="減価償却(経費・百万円)" className={inp} />
                  <AmountChips amounts={SMALL_COST_AMOUNTS} activeValue={formData.dep_expense} onSelect={(value) => setQuickValue('dep_expense', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="rent" value={formData.rent} min="0" step="0.1" onChange={handleChange} placeholder="賃借料(資産・百万円)" className={inp} />
                  <AmountChips amounts={SMALL_COST_AMOUNTS} activeValue={formData.rent} onSelect={(value) => setQuickValue('rent', value)} />
                </div>
                <div>
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="rent_expense" value={formData.rent_expense} min="0" step="0.1" onChange={handleChange} placeholder="賃借料(経費・百万円)" className={inp} />
            ...
            {step === 6 && (
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <input type="number" inputMode="numeric" data-wizard-number="true" name="contracts" value={formData.contracts} min="0" step="1" onChange={handleChange} placeholder="契約件数" className={inp} />
                  <div>
                    <input type="number" inputMode="decimal" data-wizard-number="true" name="bank_credit" value={formData.bank_credit} min="0" step="0.1" onChange={handleChange} placeholder="銀行与信残(百万円)" className={inp} />
                    <AmountChips amounts={CREDIT_AMOUNTS} activeValue={formData.bank_credit} onSelect={(value) => setQuickValue('bank_credit', value)} />
                  </div>
                  <div>
                    <input type="number" inputMode="decimal" data-wizard-number="true" name="lease_credit" value={formData.lease_credit} min="0" step="0.1" onChange={handleChange} placeholder="リース与信残(百万円)" className={inp} />
            ...
            {step === 7 && (
              <div className="grid grid-cols-2 gap-2">
                <div className="col-span-2">
                  <input type="number" inputMode="decimal" data-wizard-number="true" name="acquisition_cost" value={formData.acquisition_cost} min="0" step="0.1" onChange={handleChange} placeholder="取得価格 (百万円) ※必須" className={errors.acquisition_cost ? inpErr : inpReq} />
                ...
                <div>
                  ...
                  <input type="number" inputMode="numeric" data-wizard-number="true" name="lease_term" value={formData.lease_term} min="1" step="1" onChange={handleChange} className={inp} />
                ...
                <div className="col-span-2">
                  ...
                  <input type="number" inputMode="numeric" data-wizard-number="true" name="acceptance_year" value={formData.acceptance_year} min="1900" max="2100" step="1" onChange={handleChange} className={inp} />
                </div>
              </div>
            )}
