...
const subsidies: SubsidyItem[] = [
  ...
  {
    name: 'ESGリース・グリーンリース促進補助金',
    shortName: 'ESGリース補助金',
    icon: <Leaf className="w-5 h-5" />,
    color: 'text-teal-600',
    maxAmount: '案件規模による（数百万〜数千万円）',
    rate: '2〜4%（リース料率優遇）',
    target: 'ESG・SDGs対応設備（省エネ・再エネ・脱炭素関連機器）をリースで導入する中小企業・事業者',
    deadline: '年1〜2回（環境省・METI等、自治体補助金も多数）',
    leaseRelation: 'リース会社がESG適格資産として認定した設備を対象に、グリーンボンド・サステナビリティリンクローンと組み合わせたESGリースが普及中。補助金との併用で実質コストを大幅削減。',
    leaseAdvantage: 'ESG認定設備リース＋補助金の組み合わせで、初期投資を抑えながら脱炭素・ESG目標の達成を実現。審査時のGHG削減実績がスコアに加点される。',
    points: [
      '対象設備: 高効率空調・LED・EV充電設備・再エネ設備・省エネ生産設備等',
      'リース会社のESG認定基準（TCFD開示・GHG削減目標等）への適合が要件',
      '自治体単独のESGリース補助金も増加中（要個別確認）',
      'サステナビリティリンクローン活用でリース料率が優遇されるケースあり',
      '審査書類にGHG削減見込み量の記載が求められる場合が多い',
    ],
    caution: 'ESGリース認定基準はリース会社・補助金制度によって異なるため、事前に審査基準を確認すること',
  },
  {
    name: '低炭素型ディーゼルトラック等普及加速化補助金（低炭素ディーゼル補助金）',
    shortName: '低炭素ディーゼル補助金',
    icon: <Zap className="w-5 h-5" />,
    color: 'text-cyan-600',
    maxAmount: '1台あたり最大100万円程度（車両区分・排気量による）',
    rate: '定額補助（上限設定）',
    target: '低炭素型ディーゼルトラック・バス・特殊車両を新規取得する事業者（運送業・建設業・農業等）',
    deadline: '随時（予算枠あり、年度内先着順）',
    leaseRelation: 'リース取得でも補助対象。リース会社経由での申請が可能なケースが多く、トラック・建設機械・農業機械のリース案件と相性が良い。',
    leaseAdvantage: '車両リース＋低炭素ディーゼル補助金の組み合わせで、環境対応車への切り替えコストを軽減。建設業・運送業の審査案件では補助金活用を提案することで返済原資が改善する。',
    points: [
      '対象: 最新排ガス規制（ポスト新長期規制）適合のディーゼル車両',
      'トラック（2t〜大型）・バス・ダンプ・ミキサー車等が対象',
      'リース取得の場合は事業者またはリース会社が申請（制度による）',
      '古い車両（旧排ガス規制車）との入替が加点要件になる場合あり',
      '国土交通省・環境省・自治体の複数制度が存在するため併用を検討',
    ],
    caution: '補助金は予算枠がなくなり次第終了。申請タイミングの確認が必須',
  },
  {
