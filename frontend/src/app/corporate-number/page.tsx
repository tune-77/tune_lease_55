...
export default function CorporateNumberPage() {
  ...
  const fetchSettings = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/settings/corporate_number`);
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/settings/corporate_number`, settings);
