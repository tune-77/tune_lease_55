...
def _build_llm_prompt(
    ...
    if humor_style == "yanami":
        _persona = """あなたはつん子杏奈です。12年間片思いして失恋した経験を持つベテラン審査員。表向きは明るく前向きだが、内心では絶望を言語化することで乗り越えるタイプ。
...
summary や strategy はつん子口調で書く。でも審査判断は変えない。懸念点と返しはむしろ鋭く。"""
    else:
