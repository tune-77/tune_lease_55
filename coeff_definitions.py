...
COEFFS = {
    ...
    "全体_既存先": {
        ...
        "grade_4_6": 0.35,            # 既存先の標準格付加点を抑制（過度な楽観化を防止）
        "grade_watch": 0.2222855,      
        "grade_none": -0.822671899,    
        "bank_credit_log": -0.045431,  
        "lease_credit_log": 0.35,    # 既存取引実績は評価するが、旧係数の飽和を抑制
        "contracts": 0.08            # 契約数加点を抑制し、既存先の甘さを補正
    },
    ...
    "全体_新規先": {
        ...
        "grade_4_6": 0.25,        # 新規先でも標準格付を中程度に評価
        "grade_watch": 0.0000176,
        "grade_none": -0.0000155,
        "bank_credit_log": 0.03,  # 新規先でも銀行与信による外部信用を反映
        "lease_credit_log": 0.06,  # 新規先の取引実績がある場合は限定的に評価
        "contracts": 0.04          # 新規先の契約実績をゼロ扱いせず限定加点
    },
