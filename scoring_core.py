...
def generate_asset_warnings(
    ...
    MAPPING = [
        (["トラック", "スーパーグレード", "プロフィア", "キャリイ", "elf", "エルフ",
          "キャンター", "デュトロ", "ダイナ", "レンジャー"],      5, "高"),
        (["フォークリフト"],                                       4, "高"),   # 別表第一・車両及び運搬具
        (["ブルドーザー"],                                         8, "中"),   # 別表第二55号・自走式作業用機械
        (["クレーン"],                                             8, "中"),   # 別表第二55号・自走式作業用機械
        (["ショベル", "バックホウ", "ユンボ"],                     8, "中"),   # 別表第二55号・パワーショベル
        (["医療", "介護", "mri", "ct", "レントゲン", "透析"],    6, "中"),
